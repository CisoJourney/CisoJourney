    ...
    <div class="content-wrapper">
      <div class="content-trio">
        <div class="content-block center-text">
          <div class="block-icon ciso-colors"><i class="fas fa-flag"></i></div>
      ...
      <div class="content-trio">
        <div class="content-block center-text">
          <div class="block-icon training-colors"><i class="fas fa-dumbbell"></i></div>
      ...
      <div class="content-trio center-text">
        <div class="content-block">
          <div class="block-icon labs-colors"><i class="fas fa-flask"></i></div>
